...
# Setup the warmup stage
print('Joint learning stage begins!')
print(f'Learning rate changed to {opt.lr_joint}')

for epoch in range(opt.epoch_count, total_epoch + 1):  # outer loop for different epochs
    ...
    for i, data in enumerate(dataset):  # inner loop within one epoch
        ...
        # Optimize parameters
        model.optimize_parameters()  # No SNR argument needed here

 # Update this if your method signature for optimize_parameters has changed
